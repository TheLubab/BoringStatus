...
export const statusPage = pgTable("status_page", {
	...
	slug: text("slug").notNull().unique(), // status.yoursite.com/slug
	description: text("description"),

	customDomain: text("custom_domain").unique(), // e.g. status.example.com
	password: text("password"), // Private pages
